...
if __name__ == "__main__":
    dataList = os.listdir(r"C:\Users\admin\Downloads\Dataset\Dataset")
    for i in dataList:
        if os.path.exists(os.path.join("./data/",i+".npy")) == False:
            continue
        y, sr = librosa.load(os.path.join(r"C:\Users\admin\Downloads\Dataset\Dataset", i))
        mlmc = process(y, sr)
        np.save("./data/"+i + ".npy", mlmc)